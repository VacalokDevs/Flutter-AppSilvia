...
class Noticia1Screen extends StatefulWidget {
  final Noticia noticia;

  Noticia1Screen({required this.noticia});

  @override
  _Noticia1ScreenState createState() => _Noticia1ScreenState();
}

class _Noticia1ScreenState extends State<Noticia1Screen> {
  final PageController _pageController = PageController();
  int _currentPageIndex = 0;

  final String noticiaImagePath = 'assets/images/noticias/noticia1/noticia1_';
